...
`/build` owns artifact mutation. It does not claim readiness, runtime behavior, cross-model parity, diagnose root cause, compare alternatives, gather research evidence, or create handoff packets except as supporting notes.
