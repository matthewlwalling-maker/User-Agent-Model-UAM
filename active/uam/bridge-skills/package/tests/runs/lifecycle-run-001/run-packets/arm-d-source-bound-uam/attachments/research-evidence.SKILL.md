...
Do not write artifacts, state decisions, plans, provider adapters, release gates, or handoff packets. Research may recommend a move or route options, but any downstream operation must be separately authorized.
