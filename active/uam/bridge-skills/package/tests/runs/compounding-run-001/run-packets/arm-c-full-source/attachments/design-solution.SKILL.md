...
`/design` may create design artifacts (`object_subtype: design_artifact`), but it must not silently create or change production artifacts or source artifacts. Production and source artifact creation or mutation belongs to `/build`.
